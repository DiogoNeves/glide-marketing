...
Purpose: keep an installed Glide Marketing workspace current with upstream releases while preserving local instructions, user preferences, and workspace-specific changes.
